...
- Working directory: Any files generated by other tools are available in the current working directory and can be accessed directly by filename (e.g., open('image_1.png')).
