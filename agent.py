...
GET_ORDERS_PROMPT_2 = " directly by their name using the second person, according to your personality. Begin your response with their name. Provide clear and detailed instructions based on the plan above, reminding them to focus exclusively on their assigned task. If this is not the last task, remind them not to solve or expand on subsequent tasks."
