...
IMAGE_GENERATION_SPECS: these are the general features of the images you want to generate. This text will be prepended to the prompt used to generate each image (default: 4K RAW photo, shot on Sony A7R V with 50mm prime lens, ISO 100, 32-bit HDR, razor-sharp focus, deep depth of field, best quality, highly detailed, volumetric lighting, vibrant colors)
